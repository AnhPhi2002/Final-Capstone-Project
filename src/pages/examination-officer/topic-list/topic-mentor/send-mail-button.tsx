...
import { sendApprovedTopicsNotification, resetState } from "@/lib/api/redux/sendEmailSlice";
...
const SendMailButton = ({ semesterId }: SendMailButtonProps) => {
  ...
  const handleSendEmails = async () => {
    ...
    try {
      await dispatch(
        sendApprovedTopicsNotification({
          semesterId,
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            <div className="flex justify-between items-center mb-4">
              ...
              <Button
                variant="outline"
                onClick={() => navigate("/examination/template-detail")}
              >
                Quản lý Templates
              </Button>
            </div>
