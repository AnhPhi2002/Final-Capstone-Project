...
// export const UpdateReviewTopic: React.FC<{ topicId: string }> = ({ topicId }) => {
...
//   // Khi mở modal, chỉ set giá trị lần đầu tiên
//   useEffect(() => {
//     if (open && topicDetails) {
//       setNameVi(topicDetails.nameVi || "");
//       setNameEn(topicDetails.nameEn || "");
//       setDescription(topicDetails.description || "");
//     }
//   }, [open]); // Chỉ chạy khi open thay đổi, không theo dõi topicDetails
...
//       setOpen(false);
//       dispatch(fetchTopicDetail(topicId)); // Cập nhật lại dữ liệu hiển thị
//     } catch (error: any) {
