...
export const ReviewTopicDetailPage = () => {
  ...
  const handleBack = () => {
    navigate("/examination/review-topic-list");
  };
  return (
    <div>
      <Header title="Danh sách đề tài chờ xét duyệt" href="/examination/review-topic-list" currentPage="Chi tiết đề tài chờ xét duyệt" />
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center mt-5 mb-5">
          ...
          <Link
            to={`/examination/review-topic-detail/${topicId}/${semesterId}/update`}
          >
