...
export function DeadineTopicDetailPage() {
  ...
  if (error || filteredRounds.length === 0) {
    return (
      <div className="flex flex-col h-screen">
        <Header title="Không tìm thấy" href="/graduation-thesis/deadline-topic" currentPage="Chi tiết vòng nộp" />
  ...
  return (
    <div className="flex flex-col h-screen">
      <Header title="Thời gian đăng kí đợt đề tài" href="/graduation-thesis/deadline-topic" currentPage=" Chi tiết thời gian đăng kí đợt đề tài" />
