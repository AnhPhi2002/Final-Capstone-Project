...
type CardCouncilProps = {
  councils: CouncilDefense[];
  semesterId: string;
};

// ✅ Chuẩn hóa type sang tiếng Việt
...
export const CardCouncil: React.FC<CardCouncilProps> = ({
  ...
  const handleCardClick = (councilId: string) => {
    navigate(`/graduation-thesis/council-defense/${councilId}/${semesterId}`);
  };
              ...
              return (
                ...
                >
                  <CardHeader>
                    ...
                    <CardDescription>
                      Bắt đầu: {formatDate(council.councilStartDate)} - Kết thúc:{" "}
